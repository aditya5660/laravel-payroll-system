...
<div class="container-fluid ">
	...
	<h3 class="mb-5">SELAMAT DATANG DI PAYROLL-SYSTEM<h3>
	...
	<div class="animated fadeIn">
	  <div class="row">
		{{-- <div class="col-sm-6 col-lg-3">
		  <div class="card text-white bg-primary">
			<div class="card-body pb-0">
			  ...
			  <h4 class="mb-0">9.823</h4><br>
			<a class=""href="{{route('jabatan.index')}}"><p>Karyawan</p></a>	
			</div>
		...
		<div class="col-6 col-lg-4">
			<div class="card">
			  <div class="card-body p-3 clearfix">
				<i class="fa fa-user bg-info p-3 font-2xl mr-3 float-left"></i>
				<div class="text-muted text-uppercase font-weight-bold font-xs">KARYAWAN</div>
			  </div>
			  <div class="card-footer px-3 py-2">
				<a class="font-weight-bold font-xs btn-block text-muted" href="{{route('karyawan.index')}}"">View More <i class="fa fa-angle-right float-right font-lg"></i></a>
			  </div>
			</div>
		  </div>
		<!--/.col-->
		...
		<div class="col-6 col-lg-4">
			<div class="card">
			  <div class="card-body p-3 clearfix">
				<i class="fa fa-list bg-info p-3 font-2xl mr-3 float-left"></i>
				<div class="text-muted text-uppercase font-weight-bold font-xs">JABATAN</div>
			  </div>
			  <div class="card-footer px-3 py-2">
				<a class="font-weight-bold font-xs btn-block text-muted" href="{{route('jabatan.index')}}"">View More <i class="fa fa-angle-right float-right font-lg"></i></a>
			  </div>
			</div>
		  </div>
		...
		<div class="col-6 col-lg-4">
			<div class="card">
			  <div class="card-body p-3 clearfix">
				<i class="fa fa-newspaper-o bg-info p-3 font-2xl mr-3 float-left"></i>
				<div class="text-muted text-uppercase font-weight-bold font-xs">ABSENSI</div>
			  </div>
			  <div class="card-footer px-3 py-2">
				<a class="font-weight-bold font-xs btn-block text-muted" href="{{route('absensi.index')}}">View More <i class="fa fa-angle-right float-right font-lg"></i></a>
			  </div>
			</div>
		  </div>
